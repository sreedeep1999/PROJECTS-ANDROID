...
import com.example.smartscheduling.Adapter.bookingHistoryListAdapter;
...
public class BookingHistoryActivity extends AppCompatActivity {
    ...
    private RecyclerView bookingHistoryListRV;
    private String ip;
    private String uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookingHistoryListRV = (RecyclerView) findViewById(R.id.bookingHistoryListRecyclerView);
        bookingHistoryListRV.setLayoutManager(new LinearLayoutManager(this));
        bookingHistoryListRV.setItemAnimator(new DefaultItemAnimator());
    ...
    private void loadBookingHistory() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+ip+"/SmartScheduling/API/bookingHistory.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                bookingHistoryListAdapter adapter = new bookingHistoryListAdapter(BookingHistoryActivity.this,bookingList);
                bookingHistoryListRV.setAdapter(adapter);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BookingHistoryActivity.this);
