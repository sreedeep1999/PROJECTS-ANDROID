...
public class bookingListAdapter extends RecyclerView.Adapter<bookingListAdapter.MyViewHolder>  {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.raw_mybookings, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.navigateBT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Toast.makeText(mtx, ""+lists.getHotel_latitude()+"  "+lists.getHotel_longitude(), Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?daddr="+lists.getHotel_latitude()+","+lists.getHotel_longitude()));
